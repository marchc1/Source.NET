...
public class TEBubbleTrail : BaseTempEntity
{
	public static readonly SendTable DT_TEBubbleTrail = new(DT_BaseTempEntity, [
		...
		SendPropFloat(FIELD.OF(nameof(LWaterZ)), 17, 0),
		SendPropInt(FIELD.OF(nameof(Count)), 8, PropFlags.Unsigned),
		SendPropFloat(FIELD.OF(nameof(Speed)), 17, 0),
	]);
	public static readonly new ServerClass ServerClass = new ServerClass("TEBubbleTrail", DT_TEBubbleTrail).WithManualClassID(StaticClassIndices.CTEBubbleTrail);
