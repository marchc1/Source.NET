// Thanks https://github.com/joaoportela/CircularBuffer-CSharp
...
/// </summary>
public class SizedCircularBuffer<T> : IEnumerable<T>
{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="SizedCircularBuffer{T}"/> class.
	/// 
	/// </summary>
	/// <param name='capacity'>
	/// Buffer capacity. Must be positive.
	/// </param>
	public SizedCircularBuffer(int capacity)
		: this(capacity, new T[] { }) {
	}
	...
	/// any enumerable.
	/// </param>
	public SizedCircularBuffer(int capacity, T[] items) {
		if (capacity < 1) {
